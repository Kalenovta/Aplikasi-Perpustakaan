...
class KategoriGuruComponent extends Component
{
    ...
    {
         if($this->cari!=""){
            $data['kategori']=kategori::where('nama', 'like','%'. $this->cari . '%')
            ->paginate(10);
        }
        else{
        ...
        return view('livewire.kategori-guru-component', $data)->layoutData($layout)->layout('components.layouts.guru');
    }
