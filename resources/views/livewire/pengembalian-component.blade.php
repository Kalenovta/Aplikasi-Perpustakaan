                    ...
                    <tbody>
                        @forelse($pengembalian as $data)
                            <tr>
                                ...
                                <td>{{ optional($data->pinjam)->user?->name ?? '-' }}</td>
                                <td>{{ optional($data->pinjam)->buku?->judul ?? '-' }}</td>
                                <td>{{ $data->pinjam?->tgl_pinjam ? \Carbon\Carbon::parse($data->pinjam->tgl_pinjam)->format('d/m/Y') : '-' }}</td>
                                <td>{{ $data->pinjam?->tgl_batas ? \Carbon\Carbon::parse($data->pinjam->tgl_batas)->format('d/m/Y') : '-' }}</td>
                                <td>{{ $data->tgl_kembali ? \Carbon\Carbon::parse($data->tgl_kembali)->format('d/m/Y') : '-' }}</td>
                                ...
                                <td><a href="#" wire:click="confirm({{ $data->id }})" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#deletePage">Hapus</a></td>
                            </tr>
                        @empty
                            <tr>
